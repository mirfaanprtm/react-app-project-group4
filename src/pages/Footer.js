      ...
      <div style={styles.itemContainer}>
        <div style={styles.leftSection}>
          ...
          <p style={styles.description}>
            ...
            <br />
            Menyediakan air bersih yang sehat yang mampu memberikan kontribusi
            PAD pada kabupaten Grobogan
          </p>
          <div style={styles.sosmed}>
            {ICON_SOSMED.map((item, idx) => (
              <IconLink key={idx} iconSrc={item.src} to={item.href} />
            ))}
          </div>
        </div>
        <div style={styles.centerSection}>
          <div style={styles.navigasi}>NAVIGASI</div>
          <div>
            <a href="#" style={styles.menuHome}>
              Home
            </a>
          </div>
          <div>
        ...
        <div style={styles.righSection}>
          <div style={styles.kontak}>KONTAK</div>
          ...
          <div style={styles.kontakSection}>
            ...
            <div style={styles.whatsAppNumber}>+62 896 666 666</div>
          </div>
          <div style={styles.kontakSection}>
            <img style={styles.emailIcon} src={emailIcon} />
            <div style={styles.emailText}>hallo@purwatirtadharma.com</div>
          </div>
        </div>
      </div>
    </div>
